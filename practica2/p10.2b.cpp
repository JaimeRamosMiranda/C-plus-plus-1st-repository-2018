/*
10.- Escribir un algoritmo que permita realizar una encuesta 
a 6 personas preguntando por su bebida favorita (Pepsi Cola, Coca Cola, Kolareal), 
...
{int i,p,c,k,op;
 int repite;
  ...
  cout<<" [3]: Kola Real"<<endl;
  do
  {cout<<"Sr(a). cual es su bebida de preferencia ? final 9";
  cin>>op;
  }while((op!=1&&op!=2&&op!=3)&&(op!=9));
  }
if((p==c)&&(p==k)&&(k==c))
